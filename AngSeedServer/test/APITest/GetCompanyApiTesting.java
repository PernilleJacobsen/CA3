...
public class GetCompanyApiTesting
{

    static Server server;

    public GetCompanyApiTesting()
    {
    ...
    public void getCompany()
    {
        ...
        given().
                ...
                when().
                get("/getCompany/vat/3167 8021/dk").
                then().
                statusCode(200).
                body("name", equalTo("EA Copenhagen Business"));
    }

    @Test
    public void getByNameCompany()
    {
        String json = given().
                contentType("application/json").
                body("{'username':'user','password':'test'}").
        ...
        given().
                ...
                header("Authorization", "Bearer " + from(json).get("token")).
                when().
                get("/getCompany/name/EA Copenhagen Business/dk").
                then().
                statusCode(200).
    ...
    public void failGetCompany()
    {
        ...
        given().
                ...
                header("Authorization", "Bearer " + from(json).get("token")).
                when().
                get("/getCompany/vat/3166 8021/dk").
                then().
                statusCode(404);
    }
}
